...
- [ ] **BOOT-01**: Unity project initialized for iOS with URP and `Assets/_Project/...` folder structure (Scripts subfolders per system, ScriptableObjects subfolders per data type)
